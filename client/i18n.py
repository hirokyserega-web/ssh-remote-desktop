...
_EN: dict[str, str] = {
    ...
    'Сортировка:': 'Sort:',
    # HostKeyDialog
    'Подтверждение ключа сервера': 'Server key confirmation',
    'Неизвестный ключ сервера': 'Unknown server key',
    'Ключ сервера ИЗМЕНИЛСЯ': 'Server key CHANGED',
    'Хост <b>{}:{}</b> предъявил следующий отпечаток ключа (SHA256):': 'Host <b>{}:{}</b> presented the following key fingerprint (SHA256):',
    'Ранее сохранённый отпечаток:': 'Previously stored fingerprint:',
    'Новый отпечаток:': 'New fingerprint:',
    '⚠️ ВНИМАНИЕ: ключ отличается от ранее сохранённого.\nЭто может означать атаку «человек посередине» либо переустановку сервера. Подтверждайте только если вы уверены в причине.': '⚠️ WARNING: the key differs from the previously stored one.\nThis may indicate a man-in-the-middle attack or a server reinstall. Confirm only if you are sure of the cause.',
    'Запомнить ключ и больше не спрашивать': 'Remember key and do not ask again',
    'Доверять': 'Trust',
    'Отклонить': 'Reject',
    # MainWindow missing keys
    'подключено': 'connected',
    'Ошибка соединения': 'Connection error',
    'файл загружен': 'file uploaded',
    'загрузка {}…': 'uploading {}…',
    'ошибка загрузки: {}': 'upload error: {}',
    'сессия {} | backend={} | {}x{} | {} FPS': 'session {} | backend={} | {}x{} | {} FPS',
    'имя': 'name',
    'размер': 'size',
    'дата': 'date',
    ...
    # Server GUI (rd-server-gui)
    'Настройки сервера': 'Server settings',
    'Сеть': 'Network',
    'Бэкенд:': 'Backend:',
    'Сессии': 'Sessions',
    'Макс. сессий:': 'Max sessions:',
    'Таймаут простоя (с):': 'Idle timeout (s):',
    'Кодирование': 'Encoding',
    'Битрейт (кбит/с):': 'Bitrate (kbit/s):',
    'Общая папка:': 'Shared folder:',
    'Аутентификация': 'Authentication',
    'Разрешить пароль': 'Allow password',
    'Разрешить публичный ключ': 'Allow public key',
    'Запускать от имени пользователя': 'Run as user',
    'Журнал': 'Logging',
    'Уровень журнала:': 'Log level:',
    'Файл журнала:': 'Log file:',
    'Управление сервером': 'Server control',
    'Старт': 'Start',
    'Стоп': 'Stop',
    'Перезапуск': 'Restart',
    ...
    'Автозапуск при загрузке': 'Autostart at boot',
    'Управление: systemd': 'Managed by: systemd',
    'Управление: демон': 'Managed by: daemon',
    'Лог сервера': 'Server log',
    'Сохранить': 'Save',
    'Применить и сохранить': 'Apply and save',
    'Свернуть в трей при закрытии': 'Minimize to tray on close',
    'Трей': 'Tray',
    'Открыть': 'Open',
    'Выход': 'Quit',
    'Настройки сохранены': 'Settings saved',
    'Настройки невалидны': 'Settings invalid',
    'Сервер запущен': 'Server started',
    'Не удалось запустить сервер': 'Failed to start server',
    'Сервер остановлен': 'Server stopped',
    'Не удалось остановить сервер': 'Failed to stop server',
    'Сервер перезапущен': 'Server restarted',
    'Не удалось перезапустить сервер': 'Failed to restart server',
    'Автозапуск включён': 'Autostart enabled',
    'Автозапуск выключен': 'Autostart disabled',
    'Системный юнит не установлен — автозапуск недоступен': 'Systemd unit not installed — autostart unavailable',
    'Не удалось сохранить конфигурацию:\\n{err}': 'Could not save configuration:\\n{err}',
    'rd-server-gui': 'rd-server-gui',
}
